...
encryptedWord = cipherText(cylinder, key, "Lorem ipsum")
print("MINI-TP Asked Encoded Text : " + encryptedWord)

cylinder = loadCylinder('cylinder.txt')
print("MINI-TP Decoded Text : " + unCipherText(cylinder, key, encryptedWord))
